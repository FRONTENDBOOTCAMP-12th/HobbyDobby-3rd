...
- Frontend :<br>
  ![My Skills](https://skillicons.dev/icons?i=ts,vite,react,css)
- Backend & Deploy :<br>
  ![My Skills](https://skillicons.dev/icons?i=supabase,netlify)

- Cooperation :<br>
  ![My Skills](https://skillicons.dev/icons?i=discord,notion,github)
...
<details>
<summary>📁 HOBBYDOBBY-3RD</summary>
